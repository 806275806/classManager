...
var closableTab = {
	...
	addTab:function(tabItem){ //tabItem = {id,name,url,closable}
		...
		if(!$('#'+id)[0]){
			var li_tab = '<li role="presentation" class="" id="'+id+'"><a class="tab_sty" href="#'+container+'"  role="tab" data-toggle="tab" style="position: relative;padding:10px 20px 10px 15px;">'+tabItem.name;
			if(tabItem.closable){
